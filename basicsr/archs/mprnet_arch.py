...
class MPRNet(nn.Module):
    def __init__(self, in_c=6, out_c=6, n_feat=24, scale_unetfeats=20, scale_orsnetfeats=16, num_cab=8, kernel_size=3, reduction=4, bias=False,img_size=512,**kwargs):
    ...
    def forward(self, x3_img):
        ...
        x3_img = torch.cat((zeros, x3_img), dim=1)        
        x3_img = x3_img 
