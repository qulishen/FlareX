...
class AST(nn.Module):
    def __init__(self, img_size=512, in_chans=3, output_ch=6,dd_in=3,
        ...
        self.output_proj = OutputProj(in_channel=2*embed_dim, out_channel=output_ch, kernel_size=3, stride=1)
